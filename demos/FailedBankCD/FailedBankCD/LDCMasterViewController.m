...
#import "LDCMasterViewController.h"
#import "FailedBankInfo.h"

@interface LDCMasterViewController ()

@end

@implementation LDCMasterViewController
...
- (void)viewDidLoad
{
    ...
    //Create a fetch request to get all of the FailedBankInfos in the database, and store it in our member variable
